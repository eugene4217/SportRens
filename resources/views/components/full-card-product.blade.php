              ...
              <div class="price-block-product">
                  ...
                  <div class="price-block-body">
                      ...
                      <div class="block-info-product">
                          ...
                          <div class="step-info">
                              <span>Стоимость за час аренды:</span><p>{{$product->price_at_hour}}</p><p> рублей.</p>
                          </div>
                          <div class="step-info">
                              <span>Количество на складе:</span><p>{{$product->count_at_sklad}}</p><p> штук.</p>
                          </div>
                          <div class="step-info">
                              <span>Страна производства:</span><p>{{$product->country}}</p>
                          </div>
